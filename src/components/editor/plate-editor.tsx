...
export function PlateEditor({ initialContent, onSave, className }: PlateEditorProps) {
  ...
  return (
    <div className={cn("relative", className)}>
      ...
      <div className="absolute top-2 right-2 z-10 flex items-center gap-1.5 text-xs text-muted-foreground">
        {saving ? (
          <>
      ...
      <Plate editor={editor} onChange={handleChange}>
        ...
        <PlateContent
          ...
          className={cn(
            "min-h-[500px] px-16 py-8 outline-none focus:outline-none",
